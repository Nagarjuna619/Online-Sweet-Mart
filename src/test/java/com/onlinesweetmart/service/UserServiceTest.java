...
public class UserServiceTest {
	...
	{
		User user = User.builder().userName("John").password("john@123").passwordConfirm("john@123").type("new").build();
	...
	void cancelUserInitializer() {
		Optional<User> user = Optional.ofNullable(User.builder().userName("John").password("john@123").passwordConfirm("john@123").type("new").build());
	...
	{
		User inputUser = User.builder().userName("John").password("john@123").passwordConfirm("john@123").type("new").build();

		User outputUser = User.builder().userName("John").password("john@123").passwordConfirm("john@123").type("new").build();
